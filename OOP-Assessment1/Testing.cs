...
namespace OOP_Assessment1
{
    public class Testing
    {
        ...
        private int _D1Face;private int _D2Face; private int _D3Face; // this creates the Dice face values for testing
        private int _result; // this  creates the result 

        // creates the objects
        private Dice _D1 = new Dice();private Dice _D2 = new Dice();private Dice _D3 = new Dice(); // this creates the new dice for testing

        // runs the face check 
        public void Test()
        {
            int D1Face = _D1.Roll(); // This calls the roll method to give the dice a value 
            ...
            int D2Face = _D2.Roll(); // This calls the roll method to give the dice a value
            ...
            int D3Face = _D3.Roll(); // This calls the roll method to give the dice a value
