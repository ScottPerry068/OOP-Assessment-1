...
namespace OOP_Assessment1
{
    public class Game
    {
        private int _D1Face;private int _D2Face;private int _D3Face; // this creates the rolled dice value
        private Dice _D1 = new Dice(); private Dice _D2 = new Dice();private Dice _D3 = new Dice(); // this creates the dice 
